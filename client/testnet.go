...
import (
	...
	"github.com/airchains-network/rollup-evm/testutil/network"
)
...
Example:
	...
	cmd.Flags().String(flagNodeDaemonHome, "aircosmicd", "Home directory of the node's daemon configuration")
