...
Find below a list of `aircosmicd` commands added with the `x/evm` module. You can obtain the full list by using the `aircosmicd -h` command.
...
```go
aircosmicd query evm code ADDRESS [flags]
```

```bash
# Example
$ aircosmicd query evm code 0x7bf7b17da59880d9bcca24915679668db75f9397
...
```bash
aircosmicd query evm storage ADDRESS KEY [flags]
```

```bash
# Example
$ aircosmicd query evm storage 0x0f54f47bf9b8e317b214ccd6a7c3e38b893cd7f0 0 --height 0
...
```bash
aircosmicd tx evm raw TX_HEX [flags]
```

```bash
# Example
$ aircosmicd tx evm raw 0xf9ff74c86aefeb5f6019d77280bbb44fb695b4d45cfe97e6eed7acd62905f4a85034d5c68ed25a2e7a8eeb9baf1b84
